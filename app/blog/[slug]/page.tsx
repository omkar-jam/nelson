  ...
  return (
    <main className="min-h-screen bg-plati-dark font-body text-paper">
      ...
      <article className="mx-auto max-w-2xl px-6 py-16">
        ...
        <div
          className="prose prose-invert mt-8 max-w-none text-night-soft prose-p:font-body prose-p:text-body prose-a:text-gleam prose-a:no-underline hover:prose-a:underline"
