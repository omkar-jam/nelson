...
export function HomeContent({
  ...
  return (
    <main className="min-h-screen w-full max-w-[100vw] overflow-x-hidden">
      ...
      <HeroParallax videoSrc={heroVideoUrl} posterSrc={heroPosterUrl || undefined}>
        ...
        >
          ...
          >
            ...
            <span className="block animate-scroll-hint">
      ...
      {/* Achievements Marquee — CSS infinite scroll; content-visibility keeps it out of LCP */}
      <div
        className="relative overflow-hidden border-y border-gleam/25 bg-gradient-to-r from-gleam/[0.12] via-plati/90 to-gleam/[0.12] py-3 shadow-[0_0_32px_-8px_rgba(197,191,180,0.12),inset_0_1px_0_0_rgba(197,191,180,0.2)] sm:py-4"
          ...
          <div className="mt-8 grid items-start gap-10 sm:mt-12 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-14 xl:gap-16">
            <ScrollReveal once={true} variant="fade" delay={0.1} className="relative mx-auto w-full max-w-sm lg:mx-0 lg:max-w-none">
              <figure className="relative">
                <div className="relative aspect-[3/5] overflow-hidden sm:aspect-[2/3]">
                  <Image
                    ...
                    quality={70}
                    className="artist-portrait object-cover object-[center_42%]"
                  />
                  <div
                    aria-hidden
      ...
      <section id="contact" className="relative border-t border-night-border bg-night-surface py-12 sm:py-24 md:py-32">
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 md:px-12">
          <ScrollReveal once={true} variant="slideDown">
            ...
            <div className="mt-8 grid gap-8 sm:mt-10 sm:gap-10 lg:grid-cols-2 lg:gap-12">
              {/* Map */}
                    ...
                    <>
                      ...
                      <div className="flex min-h-[48px] overflow-hidden rounded-none border border-night-border bg-night-bg focus-within:border-gold">
                        <select
                          ...
                          aria-label="Country code"
                          title={PHONE_COUNTRY_CODES.find((c) => c.iso === contactPhoneCountryIso)?.label}
                          style={{ width: '5.5rem' }}
                          className="h-full shrink-0 cursor-pointer border-r border-night-border bg-night-bg py-3 pl-2.5 pr-6 font-body text-sm text-cream focus:outline-none [&>option]:bg-night-bg [&>option]:text-cream"
                        >
                          {PHONE_COUNTRY_CODES.map(({ value, label, iso }) => (
                            <option key={iso} value={iso}>
                              {label}
                        ...
                        <div className="flex min-w-0 flex-1 items-center gap-1.5 px-3">
                          ...
                          <input
                            ...
                            autoComplete="tel-national"
                            inputMode="tel"
                            className="min-w-0 flex-1 bg-transparent font-body text-base text-cream placeholder:text-night-muted focus:outline-none"
                          />
                        </div>
                      </div>
                      <input
                      ...
                      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                        <button
                          ...
                          className="touch-target w-full border border-gold bg-gold/20 px-6 py-3 font-body text-body-sm uppercase tracking-widest text-paper transition hover:bg-gold/30 sm:w-auto sm:px-8 disabled:opacity-60"
                        >
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="touch-target inline-flex w-full items-center justify-center gap-2 border border-night-border bg-plati-elevated px-6 py-3 font-body text-body-sm uppercase tracking-widest text-night-soft transition hover:border-gold/50 hover:text-gold sm:w-auto sm:px-8"
                        >
