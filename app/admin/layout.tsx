        ...
        <header className="border-b border-plati-border bg-plati px-4 py-3 sm:px-6 md:px-12">
          <div className="mx-auto flex max-w-6xl items-center justify-between">
            ...
            <div className="flex gap-4 sm:gap-6">
              ...
              <Link href="/admin/subscribers" className="text-body-sm text-plati-soft transition hover:text-gleam">
                Subscribers
              </Link>
              <Link href="/admin/newsletter" className="text-body-sm text-plati-soft transition hover:text-gleam">
                Newsletter
              </Link>
              <Link href="/admin/settings" className="text-body-sm text-plati-soft transition hover:text-gleam">
                Settings
              </Link>
