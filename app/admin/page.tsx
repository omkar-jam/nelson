    ...
    <main className="mx-auto max-w-6xl px-4 py-12 sm:px-6 md:px-12">
      ...
      <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Link
          ...
          className="border border-plati-border bg-plati p-6 transition hover:border-gleam/50"
        >
          <h2 className="font-display text-display-sm font-medium text-paper">Pages</h2>
          <p className="mt-2 text-body text-plati-soft">
            Edit About and other page content (HTML).
          </p>
        </Link>
        <Link
          href="/admin/blog"
          className="border border-plati-border bg-plati p-6 transition hover:border-gleam/50"
        >
          <h2 className="font-display text-display-sm font-medium text-paper">Blog</h2>
          <p className="mt-2 text-body text-plati-soft">
